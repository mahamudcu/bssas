...
class CommitteeMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create committee_member" do
    assert_difference('CommitteeMember.count') do
      post committee_members_url, params: { committee_member: { added_by_id: @committee_member.added_by_id, approve_by_id: @committee_member.approve_by_id, committee_designation_id: @committee_member.committee_designation_id, committee_id: @committee_member.committee_id, description: @committee_member.description, is_approved: @committee_member.is_approved, remove_by_id: @committee_member.remove_by_id, user_id: @committee_member.user_id } }
    end
  ...
  test "should update committee_member" do
    patch committee_member_url(@committee_member), params: { committee_member: { added_by_id: @committee_member.added_by_id, approve_by_id: @committee_member.approve_by_id, committee_designation_id: @committee_member.committee_designation_id, committee_id: @committee_member.committee_id, description: @committee_member.description, is_approved: @committee_member.is_approved, remove_by_id: @committee_member.remove_by_id, user_id: @committee_member.user_id } }
