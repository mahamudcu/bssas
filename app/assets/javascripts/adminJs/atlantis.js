...
// 				minibutton.addClass('toggled');
// 				minibutton.html('<i class="fa fa-home"></i>');
// 				mini_sidebar = 1;
// 			}
// 			$(window).resize();
// 		});
...
// 			overlaybutton.html('<i class="fa fa-home"></i>');
// 		}
//
...
// 	// 	console.log("Clicked on menu", $(".nav-item > div").classList)
// 	//
...
// 		const submenu = parent.find('.collapse').first(); // target submenu
//
// 		console.log("Clicked on menu", submenu[0].classList);
//
// 		if (submenu.hasClass("show")) {
// 			parent.removeClass('submenu');
// 			submenu.removeClass('show'); // collapse
// 		} else {
// 			parent.addClass('submenu');
// 			submenu.addClass('show'); // expand
// 		}
// 	});
//
// 	//Chat Open
